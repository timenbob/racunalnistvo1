...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODM1MywidXNlciI6NTM2MX0:1qyVRP:zkVXRatPZWoOt27m2Bd0oUOcC9yB9STbeQB1NLf5M5I"
        try:
            test_data = [
                (["v = Vrsta([7, 3, 2, 4, 12, 5, 7, 9, 4])",
                  "v_urejena = uredi_z_zlivanjem(v)",
                  "s1 = str(v)",
                  "s2 = str(v_urejena)"],
                 {'s1': 'ZACETEK : 7 : 3 : 2 : 4 : 12 : 5 : 7 : 9 : 4 : KONEC',
                  's2': 'ZACETEK : 2 : 3 : 4 : 4 : 5 : 7 : 7 : 9 : 12 : KONEC'}),
                (["v = Vrsta([9, 2, 5, 4, 0, 2, 7, 4, 1, 1, 1, 3])",
                  "v_urejena = uredi_z_zlivanjem(v)",
                  "s1 = str(v)",
                  "s2 = str(v_urejena)"],
                 {'s1': 'ZACETEK : 9 : 2 : 5 : 4 : 0 : 2 : 7 : 4 : 1 : 1 : 1 : 3 : KONEC',
                  's2': 'ZACETEK : 0 : 1 : 1 : 1 : 2 : 2 : 3 : 4 : 4 : 5 : 7 : 9 : KONEC'}),
                (["v = Vrsta([])",
                  "v_urejena = uredi_z_zlivanjem(v)",
                  "s1 = str(v)",
                  "s2 = str(v_urejena)"],
                ...
                (["v = Vrsta([4, 5, 7])",
                  ...
                  "s1 = str(v)",
                  "s2 = str(v_urejena)"],
                 {'s1': 'ZACETEK : 4 : 5 : 7 : KONEC',
                  's2': 'ZACETEK : 4 : 5 : 7 : KONEC'}),
                (["v = Vrsta([4])",
                  "v_urejena = uredi_z_zlivanjem(v)",
                  "s1 = str(v)",
                  "s2 = str(v_urejena)"],
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODM1NCwidXNlciI6NTM2MX0:1qyVRP:vFacORbmOvqqbl15lxEbbDPVW_Qr3QuXFbANbusYBlo"
        try:
            test_data = [
                (["v = Vrsta([7, 3, 2, 10, 12, 5, 7, 4, 9])",
                  "v_urejena = hitro_uredi(v)",
                  "s1 = str(v)",
                  "s2 = str(v_urejena)"],
                 {'s1': 'ZACETEK : 7 : 3 : 2 : 10 : 12 : 5 : 7 : 4 : 9 : KONEC',
                  's2': 'ZACETEK : 2 : 3 : 4 : 5 : 7 : 7 : 9 : 10 : 12 : KONEC'}),
                (["v = Vrsta([9, 2, 0, 4, 5, 2, 7, 8, 1, 1, 1, 3])",
                  "v_urejena = hitro_uredi(v)",
                  "s1 = str(v)",
                  "s2 = str(v_urejena)"],
                 {'s1': 'ZACETEK : 9 : 2 : 0 : 4 : 5 : 2 : 7 : 8 : 1 : 1 : 1 : 3 : KONEC',
                  's2': 'ZACETEK : 0 : 1 : 1 : 1 : 2 : 2 : 3 : 4 : 5 : 7 : 8 : 9 : KONEC'}),
                (["v = Vrsta([])",
                  "v_urejena = hitro_uredi(v)",
                  "s1 = str(v)",
                  "s2 = str(v_urejena)"],
                ...
                (["v = Vrsta([8, 15, 16])",
                  ...
                  "s1 = str(v)",
                  "s2 = str(v_urejena)"],
                 {'s1': 'ZACETEK : 8 : 15 : 16 : KONEC',
                  's2': 'ZACETEK : 8 : 15 : 16 : KONEC'}),
                (["v = Vrsta([2])",
                  "v_urejena = hitro_uredi(v)",
                  "s1 = str(v)",
                  "s2 = str(v_urejena)"],
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODM1NSwidXNlciI6NTM2MX0:1qyVRP:lfdKRax23qk98o7iVu7xKCOLnVuGVJZzXfPTd91ZAa8"
        try:
            test_data = [
                (["v = Vrsta([7, 3, 2, 6, 11, 5, 7, 8, 4])",
                  "v_urejena = uredi_z_mehurcki(v)",
                  "s1 = str(v)",
                  "s2 = str(v_urejena)"],
                 {'s1': 'ZACETEK : 7 : 3 : 2 : 6 : 11 : 5 : 7 : 8 : 4 : KONEC',
                  's2': 'ZACETEK : 2 : 3 : 4 : 5 : 6 : 7 : 7 : 8 : 11 : KONEC'}),
                (["v = Vrsta([8, 2, 5, 3, 0, 2, 6, 4, 1, 1, 1, 3])",
                  "v_urejena = uredi_z_mehurcki(v)",
                  "s1 = str(v)",
                  "s2 = str(v_urejena)"],
                 {'s1': 'ZACETEK : 8 : 2 : 5 : 3 : 0 : 2 : 6 : 4 : 1 : 1 : 1 : 3 : KONEC',
                  's2': 'ZACETEK : 0 : 1 : 1 : 1 : 2 : 2 : 3 : 3 : 4 : 5 : 6 : 8 : KONEC'}),
                (["v = Vrsta([])",
                  "v_urejena = uredi_z_mehurcki(v)",
                  "s1 = str(v)",
                  "s2 = str(v_urejena)"],
                ...
                (["v = Vrsta([1, 2, 3])",
                  ...
                  "s1 = str(v)",
                  "s2 = str(v_urejena)"],
                 {'s1': 'ZACETEK : 1 : 2 : 3 : KONEC',
                  's2': 'ZACETEK : 1 : 2 : 3 : KONEC'}),
                (["v = Vrsta([5])",
                  "v_urejena = uredi_z_mehurcki(v)",
                  "s1 = str(v)",
                  "s2 = str(v_urejena)"],
