...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODM0MywidXNlciI6NTM2MX0:1qyVRP:B3d07Hx82xfTTQdNDbtAt_B2m7MOM1RJBMVzMgS2GWg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODM0NCwidXNlciI6NTM2MX0:1qyVRP:3R_sxSAF9YcodGHr1TFD8fudLAPk_5ls9GZDTR1nx2A"
        try:
            Check.run(["v = Vrsta([1, 2, 3, 4, 5, 6, 7, 8])",
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODM0NSwidXNlciI6NTM2MX0:1qyVRP:-CDVQNvwtEsGJZpimOsKstaFgvWVQ0XAfMYFi83JyVg"
        try:
            Check.run(["v = Vrsta([1, 2, 3, 4, 5, 6, 7, 8])",
                       "odstrani_ntega(v, 3)",
                       "potem1 = str(v)",
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODM0NiwidXNlciI6NTM2MX0:1qyVRP:u23lZ80f-G3URvmo9qvE2ivgBqgpzhVRypnIiO24bDI"
        try:
            Check.run(["v = Vrsta([1, 2, 3, 4, 5, 6, 7, 8])",
                       "odstrani_pogojno(v, lambda x: x % 2 == 0)",
                       "potem = str(v)"],
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODM0NywidXNlciI6NTM2MX0:1qyVRP:BbEob0f3M9qCcKBwGFyMph5SWYgZyHsSfkDrVVJOpjE"
        try:
            Check.run(["v = Vrsta([1, 2, 3, 4, 5, 6, 7, 8])",
                       "obrni(v)",
                       "potem = str(v)"],
