...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODM0OSwidXNlciI6NTM2MX0:1qyVRP:kl1MdFRku2e2u3ikIgRaklORwprU62Ct5WGNn4B1dUk"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODM1MCwidXNlciI6NTM2MX0:1qyVRP:Hr2NwmU2WMWAiGn1cZhLpw2RF-pu20Q86iJ4glHwuDY"
        try:
