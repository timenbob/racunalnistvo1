...
def sestaviZ(s, predmet):
    z=[]
    for el in s:
        z.append((el[0]+predmet[0],el[1]+predmet[1]))
    return z
# =====================================================================@038555=
# 3. podnaloga
...
def sestaviS(s, z):
    ...
    i_s=1
    i_z=0
    while len(s)+len(z)>i_s+i_z:##z indeksi so problemi
        if len(s)-i_s>0:
            if s[i_s][0]<z[i_z][0]:
                if novi[-1][1]<s[i_s][1]:
                    novi.append(s[i_s])
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODU1MywidXNlciI6NTM2MX0:1rLKm1:H-1f1DATUH2XTrRrYSEl1ZLyfiQD5wd8Pk4UpVfW5sA"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODU1NCwidXNlciI6NTM2MX0:1rLKm1:baR45V0KjywUqogis9Ujq95mRUHq2UStSk3IxHVp9y8"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODU1NSwidXNlciI6NTM2MX0:1rLKm1:1RKlR_aZVtNRp7_R6UyOZScPXeJzZLWrPQ9DwV1HH9o"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODU1NiwidXNlciI6NTM2MX0:1rLKm1:87Il1VKSZUJO0tXUzRKa9jrWttS3rLojEqlxPA7bkm8"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODU1NywidXNlciI6NTM2MX0:1rLKm1:zNL5T4Hpwhab0CUR-BfObjt9s29bjfRv5zNUhog4vW8"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODU1OCwidXNlciI6NTM2MX0:1rLKm1:_9Ni3t50d46P_BSmcR3TL5LGeQkmSwXAON2cVo3Dm84"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODU1OSwidXNlciI6NTM2MX0:1rLKm1:HOFPtJZYBfGszCYTxlI9pWooAGFV0ZvmwkerTiS2ipw"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODU2MCwidXNlciI6NTM2MX0:1rLKm1:ZIrhYdAMz_7IuHoa2hTU_3Un3t8EqtLm5n4RsVx0akM"
        try:
            test_data = [
