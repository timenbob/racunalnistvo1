...
# =====================================================================@038304=
# 4. podnaloga
# Blagajnik komisije za nagradno igro pa pravi, da je predsednik malo čuden in
# si z njegovo funkcijo nima kaj pomagati. Želi bolj "vizualen" rezultat.
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODMwMSwidXNlciI6NTM2MX0:1qtP6T:tFqvZKz7BlD3aCOYtLUQqVpB2dV8SVR1-wKRmxU7Ido"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODMwMiwidXNlciI6NTM2MX0:1qtP6T:CYn8JC26OWYLv21unIoK8VczJp-BvQ614dwp0vvPz5s"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODMwMywidXNlciI6NTM2MX0:1qtP6T:ob7iRik0OhFhuhtMojhLSSvOGxzNwZeYaRyQHJqx6GU"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODMwNCwidXNlciI6NTM2MX0:1qtP6T:L66h5ZSi82uAAYiXMlygOeaTberZ_uwwbUJgEUX9BQU"
        try:
