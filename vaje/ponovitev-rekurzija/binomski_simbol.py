...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI3MywidXNlciI6NTM2MX0:1qtP6T:SK3zkUOaumbJ2FqEObi-nTJ-WxmkmNwc7vpfvJQeW-U"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI3NCwidXNlciI6NTM2MX0:1qtP6T:a0OG4oBWL5fend-iHPo8I-liZ4bGjsGBjtZaImHwFcI"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI3NSwidXNlciI6NTM2MX0:1qtP6T:M78XqwSwGH6lQRVHBur8qRC-5a3ptPWpjICKqRMoHEk"
        try:
