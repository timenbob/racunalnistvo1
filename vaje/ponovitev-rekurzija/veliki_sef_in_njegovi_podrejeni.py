...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI4NSwidXNlciI6NTM2MX0:1qtP6T:w4jLZw6vmEYRjZRaB_YtvGgjD6F58_jWv_poOBuj8b8"
        try:
            tests = [
                    ("slovar_sefov([('Mojca', 'Tilen'), ('Andrej', 'Tilen'), ('Tilen', 'Zoran')])",
                        {'Andrej': 'Tilen', 'Mojca': 'Tilen', 'Tilen': 'Zoran'}),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI4NiwidXNlciI6NTM2MX0:1qtP6T:qKBTt0zUnkSmfErUGPvcu9_1axRiLrwUG1aWHX4YWbE"
        try:
            tests = [
                    ("neposredno_podrejeni([('Mojca', 'Tilen'), ('Andrej', 'Tilen'), ('Tilen', 'Zoran')])",
                        {'Zoran': {'Tilen'}, 'Tilen': {'Andrej', 'Mojca'}}),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI4NywidXNlciI6NTM2MX0:1qtP6T:m-0eNG85aKchLHcbbrE9TdhMjNmOuaeXc4MqkYfL7v4"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI4OCwidXNlciI6NTM2MX0:1qtP6T:GRo5IMxICcKXZCTmbVZqKOW7BEPSnYSO4-C4yCK2SIA"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI4OSwidXNlciI6NTM2MX0:1qtP6T:DlMSVsAGr4ZXmbvcoKRurl2hgpF9PVQsEB6pntnwoi4"
        try:
            tests = [
