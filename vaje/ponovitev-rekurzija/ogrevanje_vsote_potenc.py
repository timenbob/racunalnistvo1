...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI2OSwidXNlciI6NTM2MX0:1qtP6T:tb1lrc98uzkplvDnEO77jZ4f5GhSV-6z13aCJn6W6iI"
        try:
            resitev = Check.current_part['solution']
            if resitev.count('for') > 0 or resitev.count('while') > 0:
                Check.feedback("Nalogo rešite s pomočjo rekurzije in ne z zankami.")
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI3MCwidXNlciI6NTM2MX0:1qtP6T:0PZA-Suhd0Lq51tcIZmomkvyyHs61cAwA-kTroxkY1w"
        try:
            resitev = Check.current_part['solution']
            if resitev.count('for') > 0 or resitev.count('while') > 0:
                Check.feedback("Nalogo rešite s pomočjo rekurzije in ne z zankami.")
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI3MSwidXNlciI6NTM2MX0:1qtP6T:P1JNtxHSnYP_HhvZ0Kgs2n45-XbWEolMiofwSuxB8To"
        try:
            resitev = Check.current_part['solution']
            if resitev.count('for') > 0 or resitev.count('while') > 0:
                Check.feedback("Nalogo rešite s pomočjo rekurzije in ne z zankami.")
