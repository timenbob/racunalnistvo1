...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI3NiwidXNlciI6NTM2MX0:1qtP6T:3D-4OhYNqFGT0GbKA9zB-ByYU4curIImhlSLWBtLHwg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI3NywidXNlciI6NTM2MX0:1qtP6T:WwEpQk2C-0Y_q3H3oM006QfKqCwYNGoQ1nTZL5NLXFA"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI3OCwidXNlciI6NTM2MX0:1qtP6T:PBGEPwoa723BH4R3excd4cU3pCAPbYv84pzYZlOombE"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI3OSwidXNlciI6NTM2MX0:1qtP6T:SlGX2geS24A9PWcFAsu4aCbkktZTp05xv6ye9U7wtII"
        try:
