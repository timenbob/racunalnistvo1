...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODMwOCwidXNlciI6NTM2MX0:1qtP6T:L0W82Ah7JVJS-UQ7i-OGc2eTbc9qwnCIBAJl-HFekaY"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODMwOSwidXNlciI6NTM2MX0:1qtP6T:OocrRzFz3vrB43I39-0rVNW2ibs51mJphJbvph679Ok"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODMxMCwidXNlciI6NTM2MX0:1qtP6T:RmGW85jMGulGsOGH4HeqZ-6UlChBUf1f4SJgTnY2To8"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODMxMSwidXNlciI6NTM2MX0:1qtP6T:9nQWNxhkh8T8TEhoM_KDgoljjLZ_imBIQ3wTBgTiFAA"
        try:
