...
# Rodovniki
#
# Ukvarjali se bomo z rodovniki (Celjskih grofov in drugih). Rodovnik imamo
# podan kot slovar, kjer je ključ ime "glave rodbine" vrednost pa tabela imen
# otrok. Recimo:
# 
#     rodovnik =
...
# rodbine 1. Če ima otroka, ta pa nima vnukov (ali celo več otrok, ti pa nimajo
# vnukov), je globina rodbine 2. Če nekdo ima vnuke, vendar nobenega pravnuka,
# je globina njegove rodbine 3.
# 
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI5MCwidXNlciI6NTM2MX0:1qtP6T:jAQo5QJUPu9z6TbWSadTOnevDRQLs5lQQSnqZQIkMuA"
        try:
            rodovnikCG = {
             'Ulrik I.': ['Viljem'], 'Margareta': [], 'Herman I.': ['Herman II.', 'Hans'],
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI5MSwidXNlciI6NTM2MX0:1qtP6T:yO4D98L2jQ9qC8hSrYIFoFQP20LQXuGW00iNG5pm-fo"
        try:
            rodovnikCG = {
             'Ulrik I.': ['Viljem'], 'Margareta': [], 'Herman I.': ['Herman II.', 'Hans'],
             'Elizabeta II.': [], 'Viljem': ['Ana Celjska'], 'Elizabeta I.': [],
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI5MiwidXNlciI6NTM2MX0:1qtP6T:c_y6-vuZ2FAulgKbZMFkjYGwXCgR5POeN2xnM2NnMLc"
        try:
            rodovnikCG = {
             'Ulrik I.': ['Viljem'], 'Margareta': [], 'Herman I.': ['Herman II.', 'Hans'],
             'Elizabeta II.': [], 'Viljem': ['Ana Celjska'], 'Elizabeta I.': [],
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI5MywidXNlciI6NTM2MX0:1qtP6T:1RZMXQp0xctlsM-u1KPM10shSfQV8bnUYYuLj1RB6ng"
        try:
            rodovnikCG = {
             'Ulrik I.': ['Viljem'], 'Margareta': [], 'Herman I.': ['Herman II.', 'Hans'],
             'Elizabeta II.': [], 'Viljem': ['Ana Celjska'], 'Elizabeta I.': [],
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI5NCwidXNlciI6NTM2MX0:1qtP6T:HN6HtkdLvAstwTlGlgR02LZJ5HLdXeAWusOAnvicQdE"
        try:
            rodovnikCG = {
             'Ulrik I.': ['Viljem'], 'Margareta': [], 'Herman I.': ['Herman II.', 'Hans'],
             'Elizabeta II.': [], 'Viljem': ['Ana Celjska'], 'Elizabeta I.': [],
