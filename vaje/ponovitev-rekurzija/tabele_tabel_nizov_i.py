...
#
# Tabela tabel nizov je tabela, katere elementi so bodisi nizi bodisi tabele
# tabel nizov.
# =====================================================================@038297=
# 1. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI5NywidXNlciI6NTM2MX0:1qtP6T:47MxO4p223GPULeTP64EfRz1yysGYIaJ0_XBJV6uf-c"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI5OCwidXNlciI6NTM2MX0:1qtP6T:xaA_Ur13ZRWkteDBgsOdA0dNO-a1j8h4AwXvhgbns_U"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI5OSwidXNlciI6NTM2MX0:1qtP6T:ipCvNTqc_AdCMiFsVBNJ-eihSvtKZx_nU_c519FDLQg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODMwMCwidXNlciI6NTM2MX0:1qtP6T:uxtIYxjVzSUinhOVLG7LoRfCp2YYStBtdKaQ8K9hKmg"
        try:
