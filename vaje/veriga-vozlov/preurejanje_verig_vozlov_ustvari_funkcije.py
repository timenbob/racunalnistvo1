...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODM4MSwidXNlciI6NTM2MX0:1r124a:W8UtHwyoKciMpz9zSLSjTVaXy7WtEWjqTlj8OuSmbFc"
        try:
            test_data = [
                (["v = iz_seznama([7, 5, 2, 1, 3, 4, 9, 8])",
                  "v = preuredi_parnost(v)",
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODM4MiwidXNlciI6NTM2MX0:1r124a:3O0fwz0Rfaw6o3qaz47RJdJq75jhkoz4jS0nLCr7P2A"
        try:
            test_data = [
                (["v = iz_seznama([7, 5, 2, 1])",
                  "v = obrni_na_mestu(v)",
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODM4MywidXNlciI6NTM2MX0:1r124a:4zOkpOpYUt29GsVX2iXp4H03WjJzRfJbfzFkUhlh3iI"
        try:
