...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODM3NywidXNlciI6NTM2MX0:1r124a:PHkL180H3FKeuFQ42oAKdveN6ALmGQnxdoDPwJQ183E"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODM3OCwidXNlciI6NTM2MX0:1r124a:PVBb1fFbGgH30rwj2-UhTM8Rg7KKNK_tDsm6OCNiTtM"
        try:
            test_data = [
                (["v = iz_seznama([1, 2, 4, 7, 8])",
                  "v = vstavi_v_urejenega(v, 3)",
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODM3OSwidXNlciI6NTM2MX0:1r124a:j00CKbx26uDYCn2Twn8uocsNDgLt4rQfqwz0YgSfvzU"
        try:
            test_data = [
                (["v = iz_seznama([7, 5, 2, 5, 3, 5])",
                  "v = odstrani(v, 5)",
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODM4MCwidXNlciI6NTM2MX0:1r124a:14RLAJ0_OERIH2mUBc3-Hn-dNFVfDjQBaWUI5S7FBnQ"
        try:
            test_data = [
                (["v = iz_seznama([7, 5, 2])",
                  "v = multipliciraj_verigo(v, 3)",
