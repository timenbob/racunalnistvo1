...
def dodaj_na_konec(prvi, x):
    ...
    if prvi==None:
        ...
        while pot.naslednji != None:
            pot=pot.naslednji
        pot.naslednji=Vozel(x)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODM2MiwidXNlciI6NTM2MX0:1r124a:4fzsyRxPIjKlqofl5WA0K69YPuHc12pAwvtEAn5kaBo"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODM2MywidXNlciI6NTM2MX0:1r124a:qhqjwzREMjX-StEsIipwBeb4OIanq4yEBR-P0XJOnGs"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODM2NCwidXNlciI6NTM2MX0:1r124a:JyNwuqrwgF6re6Spa7WW02NKR3tF8Tl0tu-LZY4BMto"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODM2NSwidXNlciI6NTM2MX0:1r124a:oktqU1lm06xZv0psWS5sLNFqEJSl2v7BvFlcggZx9Us"
        try:
            test_data = [
                (["v = iz_seznama([])",
                  "l = vrni_seznam(v)"],
