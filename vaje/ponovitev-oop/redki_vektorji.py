...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIzNSwidXNlciI6NTM2MX0:1qqrqd:LmpR2_71XihhW7GqRWkqaAWPSvuK5VThOUvkQfbFdDE"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIzNiwidXNlciI6NTM2MX0:1qqrqd:Gz72hmltSKJv42l4zL4hgO5uig95DbehDyx5WpRyueY"
        try:
            test_data = [
                ("""Vektor({}).elementi""", {}),
                ("""len(Vektor({}))""", 0),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIzNywidXNlciI6NTM2MX0:1qqrqd:3EE4QEcgKbrG7MdwUTSucd8s2uALBAeYa9ZrNyUlYxc"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIzOCwidXNlciI6NTM2MX0:1qqrqd:1CoVKubdRJtEh2S6mwGsMOwlto9JYyfunxoGne1rOKQ"
        try:
            test_data = [
