...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI0OSwidXNlciI6NTM2MX0:1qqrqd:-zW5TaTnBVy5YXRCHTSExBfl9_ETTO2U6_yPKmthwDo"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI1MCwidXNlciI6NTM2MX0:1qqrqd:EpwpifNPFEWunQYUbu6k6Rn-vkRQn3pOY_U7WG-hkmQ"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI1MSwidXNlciI6NTM2MX0:1qqrqd:skriNKI1FpwGrdbTATPnYJqTvyKro61uW13pWSdyB3w"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI1MiwidXNlciI6NTM2MX0:1qqrqd:yp0Xjpr_EkXQM2d4vTA7ACBbbJRq3aQ8D1kLcpiFdiY"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI1MywidXNlciI6NTM2MX0:1qqrqd:y8VI0e1TXfri99OQRyQSt3cpRbP_vBV1CQPJ5bDn-DQ"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODI1NCwidXNlciI6NTM2MX0:1qqrqd:Dl81Xq0vI1exNw2VBRB3jc3a43m9rIIYi-MlbQU51Fg"
        try:
