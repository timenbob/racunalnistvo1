...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODE5NywidXNlciI6NTM2MX0:1qqrqd:4lLnZJiwydhfgRUDb362LxAg5iei4Qs6wy44tEDnMwQ"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODE5OCwidXNlciI6NTM2MX0:1qqrqd:TVLvQWKxWq2Oh5NwuchAmLtieQS9LYahLnWUoLmK-mY"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODE5OSwidXNlciI6NTM2MX0:1qqrqd:KH1-UxnxoXxvSRQ3gfxDetg9B52X-s34AZn1bcUu1Ec"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIwMCwidXNlciI6NTM2MX0:1qqrqd:Npoy3RmRH5Wkp4LcZEPloMUrOatUB5RVWHuf-d0Umms"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIwMSwidXNlciI6NTM2MX0:1qqrqd:Rwao7gQ1C8dDE86PpLbqCMu8KvkPoA9cBAdRrPKUe5Q"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIwMiwidXNlciI6NTM2MX0:1qqrqd:R5Cpwvlg2jE6KgpKzvlYBpf7wRf6j3wTmCSjE2mJeLE"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIwMywidXNlciI6NTM2MX0:1qqrqd:MGPE0sgNSEKK_pCNfPnLkqMMPl8KfnPj1rYeJNwe5Mw"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIwNCwidXNlciI6NTM2MX0:1qqrqd:VSx_LYX4NJRURcEqwJ2Q6Zt4F1L0t70RhcENE4-0Tsw"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIwNSwidXNlciI6NTM2MX0:1qqrqd:-z6BVwkguLEQCw4WKlaSVJN8sB6Rf2ucNZPF8Aaav24"
        try:
            tests = [
                    ('Datum(31, 12, 1999) == Datum(1, 1, 2000)', False),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIwNiwidXNlciI6NTM2MX0:1qqrqd:fABtoSZAUTqsRHDpAsbAaA7ddI0aWNxwPLOMNS9_cSQ"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIwNywidXNlciI6NTM2MX0:1qqrqd:j2__ELq5mwMJT6p98smpvejb7ig3IDMFBy8PvVLhtmA"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIwOCwidXNlciI6NTM2MX0:1qqrqd:IcpM9Q8MhA6Hq-RtV1sBA8vtujl9UkT27yRyWHtNg1E"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIwOSwidXNlciI6NTM2MX0:1qqrqd:X6SbBxjGLrWfCfmO3LTR6hq3gbvUWG8W8V0Viw2DASY"
        try:
            tests = [
