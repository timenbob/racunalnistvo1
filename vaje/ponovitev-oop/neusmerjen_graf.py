...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIyNSwidXNlciI6NTM2MX0:1qqrqd:65djbhoISnvzlBeNm23FVAr2eUV5-6XeS8FfOCeVzlk"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIyNiwidXNlciI6NTM2MX0:1qqrqd:3YWyuwMM0i5JliwMNn2NSvoMRGJSpQW-H5R4a0Nj0fo"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIyNywidXNlciI6NTM2MX0:1qqrqd:GZZxgoNNu5maSEFq38RvMe80XwJgMyLhBqrBijEkQNk"
        try:
            test_data = [
                (["g = NeusmerjenGraf([(1, 2), (2, 3), (3, 1)])",
                  "g.dodaj_vozlisce(4)",
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIyOCwidXNlciI6NTM2MX0:1qqrqd:yoiqLoaef_cqQOOSRDfzuwd4lQ9IqVS_D3Hm620B-mA"
        try:
            test_data = [
                (["g = NeusmerjenGraf([(1, 2), (2, 3), (3, 1)])",
                  "g.odstrani_vozlisce(3)",
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIyOSwidXNlciI6NTM2MX0:1qqrqd:F7t8VJVWWyKgd51WXDb6hAlmbovZ1xn-BcMS73eGdSU"
        try:
            test_data = [
                (["g = NeusmerjenGraf([(1, 2), (2, 3), (3, 1)])",
                  "g.dodaj_povezavo((1, 4))",
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODIzMCwidXNlciI6NTM2MX0:1qqrqd:wzlMmW3dTQ7gjD8UA5325TvNrg_qivVAOmuIRO69S24"
        try:
            test_data = [
                (["g = NeusmerjenGraf([(1, 2), (2, 3), (3, 1)])",
                  "g.odstrani_povezavo((1, 2))",
