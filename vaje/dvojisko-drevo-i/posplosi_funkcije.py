...
def zdruzi_podatke(f, drevo):
    if drevo.prazno:
        ...
        produkt = drevo.podatek
        if produkt_levih is not None:
            produkt = f(produkt,produkt_levih)
        if produkt_desnih is not None:
            produkt = f(produkt,produkt_desnih)
        return produkt
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ0NCwidXNlciI6NTM2MX0:1rBBSU:csyoU6gxeB243bgFsrsXsqq7JzjhwKbu5GVnX1Ye_fQ"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ0NSwidXNlciI6NTM2MX0:1rBBSU:hQcw7WdtR_bQ4DKXquo597BiGw5Wjlf4dsJtjNUBY3E"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ0NiwidXNlciI6NTM2MX0:1rBBSU:mlteX-vau78tx4BewTuJiK-bt8GjoNLKZKF7SzDQicw"
        try:
            tests = [
                ('Drevo()', 0, Drevo()),
                ('Drevo()', 1, Drevo()),
