...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQzNiwidXNlciI6NTM2MX0:1rBBSU:FTjekC_BnqcJhPXZ3q2pL6HHjgLULjWPdDw7x7Ln4as"
        try:
            pass
        except:
            Check.error(
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQzNywidXNlciI6NTM2MX0:1rBBSU:L6jVDJhP9JteuWal-YflpeZWEojuEgNACgz2VFaAhXE"
        try:
            pass
        except:
            Check.error(
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQzOCwidXNlciI6NTM2MX0:1rBBSU:_2oiv8pXGlWJYu0id1BEt09V7j5Er9t2PJw6cZx38dU"
        try:
            pass
        except:
            Check.error(
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQzOSwidXNlciI6NTM2MX0:1rBBSU:JyaLOHjMQtFfgE1lRd6_bzUPDowXUXYHsrWxuXWTq6Y"
        try:
            pass
        except:
            Check.error(
