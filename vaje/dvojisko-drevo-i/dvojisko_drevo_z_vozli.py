...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ1MSwidXNlciI6NTM2MX0:1rBBSU:6Uj6160osPJruVGp0DySfLf67LAwaYdlRpAIXW21MuU"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ1MiwidXNlciI6NTM2MX0:1rBBSU:DatnxZJUw1lLaMi6ca4UNi5ds1NwHtAQTJk9kDQkPe4"
        try:
