...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ2MCwidXNlciI6NTM2MX0:1rBBSU:OBvYC9axjLBp2SDgUltJIBdlDWUwwLoXKej8oNHN9aw"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ2MSwidXNlciI6NTM2MX0:1rBBSU:Ik9VcYcP3aiRxvPstobugznK9QU0GjerTTVvq5ojBzw"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ2MiwidXNlciI6NTM2MX0:1rBBSU:E5PQRpYkgt0vBdwQiRlA0ZOmXDRUGEpTHcYSH75AWJA"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ2MywidXNlciI6NTM2MX0:1rBBSU:-UFi94sTQGbE3QlUU9FOcicPKJ0mwqyWSx77ZHtRXhc"
        try:
            test_data = [
