...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ1MywidXNlciI6NTM2MX0:1rBBSU:6aS5A7HvXeh-WXD-E05cuEHfWByjG2WHEJR1vsV8FY0"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ1NCwidXNlciI6NTM2MX0:1rBBSU:kpI8zCyJmpNa8p5qFboGa0JZi1Fejhbns_hvG4afPxo"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ1NSwidXNlciI6NTM2MX0:1rBBSU:VAhqrrew_w3viGs5XdGOZOGOv-X7PyRmGD4i51w9EYw"
        try:
            test_data = [
