...
def drevo_v_levo(sez):
    if sez==[]:
        ...
        return Drevo(sez[-1],levo=drevo_v_levo(sez[:-1]))
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ1NiwidXNlciI6NTM2MX0:1rBBSU:XkiCMfZYWlniZRvZRgkbIFdfOa1HASQGFUgfOGQoRRM"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ1NywidXNlciI6NTM2MX0:1rBBSU:PhkEK7-qZyfIZko4cX-Ilmo6feLq594IwkD22WROuuo"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ1OCwidXNlciI6NTM2MX0:1rBBSU:IuAP99iDp1C1IGXs4LuNVdGPmOO6dKy2ykFASFjVQ-k"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ1OSwidXNlciI6NTM2MX0:1rBBSU:Wgrd7hmvgkd5scrgP3oiPT2RCa7w5nTSL43kO6z300Y"
        try:
            tests = [
                ('drevo_vsot([])', Drevo()),
