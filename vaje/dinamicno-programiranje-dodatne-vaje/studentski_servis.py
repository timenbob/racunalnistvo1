...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODUxOSwidXNlciI6NTM2MX0:1rTk6V:S37J1Jpjovx4RSCSA31IVQ23SPLSHw-0t67qMpaSnpo"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODUyMCwidXNlciI6NTM2MX0:1rTk6V:PhoEyx9mayK8ATQFu2AOw8-eixclFWBmn_U3kFf-aaM"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODUyMSwidXNlciI6NTM2MX0:1rTk6V:BgnNpox79uEKI4xvdUSMecz7KYaKgKI2eTqcEIho4EU"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODUyMiwidXNlciI6NTM2MX0:1rTk6V:JyjXUYf2qfb4WoZaag2HqBlmXRW0MVDjkwrFeF9q5yM"
        try:
