...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODUxNCwidXNlciI6NTM2MX0:1rTk6V:W6t_tEqkxE_xc35jt2nNfWKDINmzjCWXLuyvTEeKH4c"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODUxNSwidXNlciI6NTM2MX0:1rTk6V:hXTiAb2m0EXrf2T5-0f6CZwzQ5KjmIF8pN0L6opMOyw"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODUxNiwidXNlciI6NTM2MX0:1rTk6V:yuQFTF-YdR6iaPRnKCpBrk0lgug6mkozVPFvaRMQwUw"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODUxNywidXNlciI6NTM2MX0:1rTk6V:KIyGgYZi5GhOGZF_1XOydLnJwxXBTgIMNA3lne-7wQE"
        try:
