...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODUyNSwidXNlciI6NTM2MX0:1rTk6W:PUvEZR1a3FtxZrIh2SGfZGmNkP-11itSNNrVJcncO0g"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODUyNiwidXNlciI6NTM2MX0:1rTk6W:p6HozcDJNh8vDfmcMQ_STzB7Z2zjHtDM8WgNI03g8h8"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODUyNywidXNlciI6NTM2MX0:1rTk6W:C4LGBUMKVaFVedP-9h0ILkRmh3MhXILeKuoPYlZWKko"
        try:
            test_data = [
                ([95, 82, 87, 102, 75], 197),
                ([60, 120], 60),
