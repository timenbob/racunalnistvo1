...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODUxMiwidXNlciI6NTM2MX0:1rTk6V:3JaOOvRQc6in4C6oCmO2DX_qtD0vUnOrIMyTfCKJnhI"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODUxMywidXNlciI6NTM2MX0:1rTk6V:5t2kMCKEr-bDb4u1FlSnHe7avE2dAYFfA_uD-h1SdiM"
        try:
