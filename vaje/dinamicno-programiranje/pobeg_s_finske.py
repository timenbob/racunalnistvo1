...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODUwNiwidXNlciI6NTM2MX0:1rSjWt:yPeDBqzksp6HSah2ebii9i6JZySip6-Mj78MvUI8krM"
        try:
            Check.equal('pobeg([[(1, -10), (3, -10)], [(2, -10), (5, -20)], [(3, -10)], [(4, -15)], [(5, -0)]])', None)
            Check.equal('pobeg([[(1, 10), (3, -10)], [(2, 10), (5, -20)], [(3, -10)], [(4, 15)], [(5, 0)]])', [0, 3, 4, 5])
            Check.equal('pobeg([[(1, 10), (3, -10)], [(2, 10), (5, -10)], [(3, -10)], [(4, 15)], [(5, 0)]])', [0, 1, 5])
            Check.equal('pobeg([[(i+1, 0)] for i in range(100)])', list(range(101)))
            Check.equal('len(pobeg([[(i+1, 5), (i+2, -5)] for i in range(100)]))', 68)
        except TimeoutError:
