...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODUwNywidXNlciI6NTM2MX0:1rSjWt:2LYkYvnMyKKe-6wP1zNP2beAzE1Ln4yaSgZyE00WQL8"
        try:
            Check.equal('pot_pobega([[0, 1, 0, 0, 2], [0, 2, 2, 0, 0], [0, 0, 2, 2, 0], [2, 0, 0, 2, 0], [0, 2, 2, 0, 0], [0, 0, 0, 2, 2]], 5, 0, 6)', None)
            Check.equal('pot_pobega([[0, 1, 0, 0, 2], [0, 2, 2, 0, 0], [0, 0, 2, 2, 0], [2, 0, 0, 2, 0], [0, 2, 2, 0, 0], [0, 0, 0, 2, 2]], 5, 0, 8)', None)
            Check.equal('pot_pobega([[0, 1, 0, 0, 2], [0, 2, 2, 0, 0], [0, 0, 2, 2, 0], [2, 0, 0, 2, 0], [0, 2, 2, 0, 0], [0, 0, 0, 2, 2]], 3, 1, 3)', None)
            Check.equal('pot_pobega([[0, 1, 0, 0, 2], [0, 2, 2, 0, 0], [0, 0, 2, 2, 0], [2, 0, 0, 2, 0], [0, 2, 2, 0, 0], [0, 0, 0, 2, 2]], 0, 1, 5)', [])
            Check.equal('pot_pobega([[0, 1, 0, 0, 2], [0, 2, 2, 0, 0], [0, 0, 2, 2, 0], [2, 0, 0, 2, 0], [0, 2, 2, 0, 0], [0, 0, 0, 2, 2]], 3, 1, 5)', ['gor', 'levo', 'gor', 'gor', 'desno'])
            Check.equal('pot_pobega([[0, 1, 0, 0, 2], [0, 2, 2, 0, 0], [0, 0, 2, 2, 0], [2, 0, 0, 2, 0], [0, 2, 2, 0, 0], [0, 0, 0, 2, 2]], 4, 4, 8)', ['gor', 'gor', 'gor', 'levo', 'gor', 'levo', 'levo'])
        except TimeoutError:
