...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ4MSwidXNlciI6NTM2MX0:1rDin8:8ekyVuXaYJwXQZIFnhIVA56nLJJmhGlL7qk0J3-Bfu8"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ4MiwidXNlciI6NTM2MX0:1rDin8:nzKu2-vM1PgPgp3l4K9XWFYTjk3sh2TOF_zMpunlris"
        try:
