...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ3MCwidXNlciI6NTM2MX0:1rDin8:EOyBxpOFl687obSYmN_4Uoqz9uD7DquRcNQQcBLJTyY"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ3MSwidXNlciI6NTM2MX0:1rDin8:4Kc1a9wz4-84sP5J5etM9xf1lGPgLn_MKmrRfZ_G0g8"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ3MiwidXNlciI6NTM2MX0:1rDin8:gcIeQwYEQTyuCV94hihqcn6wz18Pq3M2GWaqR3MJxQw"
        try:
