...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ2NywidXNlciI6NTM2MX0:1rDin8:8eeEdigCffYyn3bjKoT6YaZQpMGmk3MLcTsI0Zwmabk"
        try:
            lucka = Drevo('Lučka', 800, levo=Drevo('Peter', 900), desno=Drevo('Tadeja', 700))
            matjaz = Drevo('Matjaž', 1100, levo=Drevo('Simona', 700), desno=Drevo('Boris', 1000, levo=lucka))
            branko = Drevo('Branko', 900, desno=Drevo('Benjamin', 1100))
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ2OCwidXNlciI6NTM2MX0:1rDin8:c_E5ACLpbbzVNpJa7Rsmb1bzDyD1lhNeIHq3fxmX9dk"
        try:
            lucka = Drevo('Lučka', 800, levo=Drevo('Peter', 900), desno=Drevo('Tadeja', 700))
            matjaz = Drevo('Matjaž', 1100, levo=Drevo('Simona', 700), desno=Drevo('Boris', 1000, levo=lucka))
            branko = Drevo('Branko', 900, desno=Drevo('Benjamin', 1100))
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ2OSwidXNlciI6NTM2MX0:1rDin8:yee0mBiwvLxoJx3GkedxLzsXxLjAFrQLH5GQgOJ_84E"
        try:
            lucka = Drevo('Lučka', 800, levo=Drevo('Peter', 900), desno=Drevo('Tadeja', 700))
            matjaz = Drevo('Matjaž', 1100, levo=Drevo('Simona', 700), desno=Drevo('Boris', 1000, levo=lucka))
            branko = Drevo('Branko', 900, desno=Drevo('Benjamin', 1100))
