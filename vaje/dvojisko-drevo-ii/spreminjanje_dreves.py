...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ2NCwidXNlciI6NTM2MX0:1rDin8:XVTrTjMrY9qOU_aeP-5tIQiMkFzqpCwb4LuPqbVJmaM"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ2NSwidXNlciI6NTM2MX0:1rDin8:86IHPBZmR_LCsXkXQdLieOke4c3RQwCWJ8KTsc6FQpg"
        try:
            test_data = [
                (["d = Drevo(5, levo=Drevo(3), desno=Drevo(2))",
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQ2NiwidXNlciI6NTM2MX0:1rDin8:lfnyCbS3vNZfknlUcd9FPry_3JZ0dClp1dQNyyPSgTc"
        try:
            test_data = [
                (["d = Drevo(5, levo=Drevo(3), desno=Drevo(2))",
