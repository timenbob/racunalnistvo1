...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQzMSwidXNlciI6NTM2MX0:1r8e7n:0yKQVICMxZ0RLiYoaNIWH9JUDoWmEIQWlxDs9BtAnCY"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQzMiwidXNlciI6NTM2MX0:1r8e7n:Qj7GbdrhGwC2q5X4hFCObW_to4jH1b4h6BPbfROXjOw"
        try:
