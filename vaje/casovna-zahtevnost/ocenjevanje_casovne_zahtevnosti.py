...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQyMSwidXNlciI6NTM2MX0:1r8e7n:h6FMKG6ojA9a8HNkncmM2mSJ46SUxZBNfEb4E3fweyg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQyMiwidXNlciI6NTM2MX0:1r8e7n:MBBH12x0l37NZDNlmTiJ_VtdvMnTaptCWi0em-05CSo"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQyMywidXNlciI6NTM2MX0:1r8e7n:Z6QqJSD23JneIG158xdcoqzo6DZGkLGz3pvpDenkRDw"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQyNCwidXNlciI6NTM2MX0:1r8e7n:SV2UNt6hAU3TqTA0n-BrYKicDKlVMN9XmtqhXaKfQFY"
        try:
