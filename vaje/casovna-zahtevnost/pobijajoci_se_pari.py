...
# in `False` sicer.
# =============================================================================
def nicelni_pari_v_urejenem(sez):
    mn=set(sez)
    inex=0
    for el in sez:
        if el!=0 and -el in mn:
            return True
        elif el==0:
            inex+=1
        if inex>=2:
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQyOSwidXNlciI6NTM2MX0:1r8e7n:LV7c418RZ_nWvvUQX2Q26C547IC_18m_chPbZ5_YT1I"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODQzMCwidXNlciI6NTM2MX0:1r8e7n:gUYgdF_EzCslW4852KlY2VwWIyggNbZeXQv7S6iPYIs"
        try:
