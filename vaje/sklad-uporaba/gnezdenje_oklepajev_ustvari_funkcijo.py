...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODMyMCwidXNlciI6NTM2MX0:1qvwSt:Rm8fsHFMs3w9T7ieLi6FIhe7Elk4UMBJHOaCCmLui8U"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozODMyMSwidXNlciI6NTM2MX0:1qvwSt:BiwWsc_XIvrVDJQLhYlUG4xd6E7nwo3heqyzbnsfvwI"
        try:
            test_data = [
                ("max_globina('burek')", 0),
